...
public final class RuntimeContract {
    ...
    public static String desktopCompatibilityBaseline() { return resolved("desktop.compatibility.baseline", "10.0.4"); }
    public static String androidCompatibilityBaseline() { return resolved("android.compatibility.baseline", "1.2.3"); }
    public static String androidLatestVersion() { return resolved("android.latest.version", "1.2.4"); }
    public static String iosCompatibilityBaseline() { return resolved("ios.compatibility.baseline", "1.2.3"); }
    public static String iosLatestVersion() { return resolved("ios.latest.version", "1.2.4"); }
