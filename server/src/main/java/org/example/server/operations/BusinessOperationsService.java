...
public class BusinessOperationsService {
 ...
 @Transactional(readOnly=true) public OperationDtos.PurchasePage purchasesPage(int page,int size,String q,String supplier,String from,String to,String paymentStatus,String due,String mail,String documentStatus,String returnStatus){
