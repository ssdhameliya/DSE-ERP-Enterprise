...
public class BusinessOperationsController {
 ...
 @GetMapping("/purchases/page") public OperationDtos.PurchasePage purchasesPage(@RequestParam(defaultValue="0") int page,@RequestParam(defaultValue="25") int size,@RequestParam(defaultValue="") String q,@RequestParam(defaultValue="") String supplier,@RequestParam(defaultValue="") String from,@RequestParam(defaultValue="") String to,@RequestParam(defaultValue="") String paymentStatus,@RequestParam(defaultValue="") String due,@RequestParam(defaultValue="") String mail,@RequestParam(defaultValue="") String documentStatus,@RequestParam(defaultValue="") String returnStatus,@RequestParam(defaultValue="true") boolean includeSummary,@RequestParam(defaultValue="true") boolean includeOptions){return s.purchasesPage(page,size,q,supplier,from,to,paymentStatus,due,mail,documentStatus,returnStatus,includeSummary,includeOptions);}
